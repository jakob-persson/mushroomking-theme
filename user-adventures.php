...
<div class="fb-profile-wrapper relative w-full h-full">
    ...
    <img id="profile-preview-img"
         ...
         class="px-4 lg:px-0 w-[720px] max-w-full rounded-[82px] h-[220px] lg:h-[400px] object-cover lg:rounded-[150px] drop-shadow-xl transition-transform duration-150 ease-out">
