...
<div class="text-|#E9EED8] bg-[#F3F3F1] lg:h-[100vh] flex flex-col h-full" style="padding-top: 128px; ">
...
<!-- divider -->
<div class=" bg-[#F3F3F1] flex" style="padding-top: 148px; "></div>
<!-- diviider ends -->


<div class="px-6 py-12 bg-[#e8efd6] lg:h-[100vh] flex justify-center" style="padding-top: 198px;
