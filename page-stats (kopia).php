...
<div class="flex w-full bg-[#1E2330] h-[40px] items-center relative">
  ...
  <div class="hidden lg:flex mx-auto text-white text-sm">
    👋 Welcome back, <?= esc_html($welcome_name) ?>
  </div>

  <!-- MOBILE avatar + name + dropdown -->
  <div class="absolute right-4 flex items-center gap-2 lg:hidden" x-data="{ open: false }">
    <button type="button" class="flex items-center gap-1 text-sm font-medium text-white" @click="open = !open">
      mushroomking
...
<div class="relative">
  ...
  <!-- MOBILE BOTTOM NAV -->
<nav class="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 flex justify-around items-center h-16 md:hidden z-50">
    <a href="#overview" class="flex flex-col items-center text-xs text-gray-600">
        <i class="fas fa-chart-line text-lg"></i>
        Insights
    </a>
    <a href="#adventures" class="flex flex-col items-center text-xs text-gray-600">
        <i class="fas fa-mountain text-lg"></i>
        Adventures
    </a>
    <a href="#harvests" class="flex flex-col items-center text-xs text-gray-600">
        <i class="fas fa-seedling text-lg"></i>
        Harvests
    </a>
    <a href="#locations" class="flex flex-col items-center text-xs text-gray-600">
        <i class="fas fa-map-marker-alt text-lg"></i>
        Locations
    </a>
    <a href="/profile" class="flex flex-col items-center text-xs text-gray-600">
